    ...
    <div class="containerApp">
        <div class="navbar">
            ...
            <div class="navLinks">
                ...
                <a href="{{ route('app.index') }}" class="aLinks active1">My Applications</a>
        ...
        @foreach ($projects as $project)
            <div class="contentForApplyProjects">

                <div class="flexCardAndButton ">
                    <div class="flexForCardProject " id="{{ $project->id }}">
                            ...
                            <div class="flexCard">
                                <div class="cardFirstPart">
                                    <div class="profile-images-card2">
                                        <div class="profile-images2">
                                            ...
                                            <img src="{{ $project->user->image }}" id="image" class="projectImage">
                                        </div>
                                    </div>
                                    <div>
                                    ...
                                    <p class="lookingForParagraphProjectApp">I'm looking for</p>
                                ...
                                <div class="cardSecondPart">
                                    ...
                                    <div>
                                        ...
                                        {{-- @if ($user->pivot->approve == 1) --}}
                                        <div>
                                            @if ($project->pivot->approve == 1)
                                                <p>Aplication Accepted<i class="far fa-check-circle"></i></p>
                                                {{-- @elseif($project->pivot->approve == )
                                                <p>Aplication Accepted<i class="far fa-check-circle"></i></p> --}}
                                            @endif
